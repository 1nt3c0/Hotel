...
namespace Hotel
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual DbSet<Гость> Гость { get; set; }
        ...
        public virtual DbSet<Статус_заселения> Статус_заселения { get; set; }
        public virtual DbSet<Статус_номера> Статус_номера { get; set; }
